...
`✠ IF YOU DON'T HAVE YOUR SESSION_ID SO U CAN GET IT CLICK ON SESSION_ID BUTTON AND PASTE YOUR NUMBER With COUNTRY CODE EXAMPLE:94788xxxxxx THEN YOU CAN GET YOUR SESSION_ID ✠`
...
```
THANKS TO DIZER,CYROX,NETHU,NOTHING,SPECIAL THANKS 😊 SXD TEAM FOR SCRIPT❤️
```
-----
<a><img src='https://i.imgur.com/LyHic3i.gif'/></a>
